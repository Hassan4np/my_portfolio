...
import p5 from "../../../assets/img/froute.jpeg"
const Portfolio = () => {
    return (
        <div className="py-10" id='portfolio'>
            <h1 className='text-5xl font-bold text-center text-[#40F8FF] py-10'>Portfolio</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                <a href="https://enchanting-wisp-d0c7ab.netlify.app" target="_blank" rel="noopener noreferrer">
                    <div className="card card-compact  bg-base-100 shadow-xl mb-2" >
                        <figure><img src={p5} className="rounded-lg" alt="" /></figure>
                        <div className=" ml-12 py-2 md:ml-[70px] md:py-3">
                            <h2 className="text-3xl font-bold text-[#40F8FF]">Froute shop</h2>
